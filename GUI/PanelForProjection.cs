    ...
    public class PanelForProjection : Panel
    {
        ...
        private void Panel_MouseWheel(object sender, MouseEventArgs e)
        {
            ...
            if (inflateX * inflateSize.Width >= 0 && inflateY * inflateSize.Height >= 0)
            {
                ...
                {
                    //spaceX = (int)(leftPaddingX - minX * ZoomInAxisParameter * inflateSizeW);
                    //spaceY = (int)(paddingY + spaceHeightForViewName - minY * zoomInYAxisParameter);
                    //e.X = (X * ZoomInAxisParameter * inflateSizeW + ((int)(leftPaddingX - minX * ZoomInAxisParameter * inflateSizeW) - offsetX)
                    //e.X = (X * ZoomInAxisParameter * inflateSizeW * inflateX + ((int)(leftPaddingX - minX * ZoomInAxisParameter * inflateSizeW * inflateX) - newOffsetX)
                    //(e.X + newOffsetX - leftPaddingX)/(e.X + offsetX - leftpaddingX) = inflateX
                    //newOffsetX = inflateX * (e.X + offsetX - leftpaddingX) + leftPaddingX - e.X
                    zoomIsOn = true;
